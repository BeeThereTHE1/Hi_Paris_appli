...
if (window.ExoCommonPage && typeof window.ExoCommonPage.initProfileWidget === 'function') {
  window.ExoCommonPage.initProfileWidget({
    containerId: 'widget-profil-header',
    registerHref: 'register.html',
    historyHref: 'historique.html',
...
loadAndRender();
if (window.ExoCommonPage && typeof window.ExoCommonPage.initBackgroundAnimation === 'function') {
  window.ExoCommonPage.initBackgroundAnimation({
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    var openQuiz = urlParams.get('openQuiz');
    if (openQuiz) {
        setTimeout(function () {
