(function () {
    ...
    if (!ExoBase) {
        console.error('ExoBase is not available for exercise 10.');
        return;
    }

    class Exo10 extends ExoBase {
        constructor() {
            super();
        ...
        async initExercise() {
            try {
                ...
                console.warn('Unable to initialize exercise 10.', error);
            }
        ...
        async saveProgress(stepIndex, status, scoreDetails) {
            ...
            try {
                ...
                console.warn('Unable to save progress for exercise 10.', error);
