(function () {
    ...
    if (!ExoBase) {
        console.error('ExoBase is not available for exercise 14.');
        return;
    }

    class Exo14 extends ExoBase {
        constructor() {
            super();
        ...
        async initExercise() {
            try {
                ...
                console.warn('Unable to initialize exercise 14.', error);
            }
        ...
        async saveProgress(stepIndex, status, scoreDetails) {
            ...
            try {
                ...
                console.warn('Unable to save progress for exercise 14.', error);
