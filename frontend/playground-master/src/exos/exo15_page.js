(function () {
    ...
    if (!ExoBase) {
        console.error('ExoBase is not available for exercise 15.');
        return;
    }
    class Exo15 extends ExoBase {
        constructor() {
            super();
        ...
        async initExercise() {
            try {
                ...
                console.warn('Unable to initialize exercise 15.', error);
            }
        ...
        async saveProgress(stepIndex, status, scoreDetails) {
            ...
            try {
                ...
                console.warn('Unable to save progress for exercise 15.', error);
                return false;
            }
        }
    }
