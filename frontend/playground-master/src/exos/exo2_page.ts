...
// ==========================================
// INTERACTIVE TUTORIAL STEP PAR ÉTAPE (EXO 2)
// ==========================================
...
function startTutorial() {
  ...
  const p = document.createElement('p');
  const text = "Launch the training of the neural network using the step-by-step button and observe how the weighs change and the loss decreases over time. Once training is complete, we will walk through the training process step by step.<br><br>First, hover over parameters to view their definitions.";
  p.innerText = text;
