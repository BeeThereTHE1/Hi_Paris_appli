(function () {
  ...
  menu.innerHTML = '\
        <div style="padding: 20px; border-bottom: 1px solid rgba(255,255,255,0.05); background: linear-gradient(to bottom, rgba(255,255,255,0.02), transparent);Outer">\
...
btnSauvegarder.onclick = async function () {
...
btnRealise.onclick = async function () {
...
function runStep2Highlight() {
  ...
  const desc = "First, modify the value of the bias and train the model.<br>Observe what happens each time the bias is modified.<br><br>Each neuron follows the form<br>y = f(x) + b";
  
  showCustomTooltip('#custom-bias-editor-group', title, desc, 'right');
