(function () {
    ...
    if (!ExoBase) {
        console.error('ExoBase is not available for exercise 4.');
        return;
    }
    class Exo4 extends ExoBase {
        constructor() {
            super();
        ...
        async initExercise() {
            try {
                ...
                console.warn('Unable to initialize exercise 4.', error);
            }
        ...
        async saveProgress(stepIndex, status, scoreDetails) {
            ...
            try {
                ...
                console.warn('Unable to save progress for exercise 4.', error);
                return false;
            }
        }
    }
