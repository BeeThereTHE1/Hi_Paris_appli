(function () {
    ...
    if (!ExoBase) {
        console.error('ExoBase is not available for exercise 9.');
        return;
    }
    class Exo9 extends ExoBase {
        constructor() {
            super();
        ...
        async initExercise() {
            try {
                ...
                console.warn('Unable to initialize exercise 9.', error);
            }
        ...
        async saveProgress(stepIndex, status, scoreDetails) {
            ...
            try {
                ...
                console.warn('Unable to save progress for exercise 9.', error);
                return false;
            }
        }
    }
